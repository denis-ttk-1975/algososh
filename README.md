# 12-ый месяц Яндекс-Практику. Курс Фронтэнд-Плюс

# Студент - Денис Улесов

## На этом месяце отрабатываем алгоритмы и структуры данных.

## Использованные технологии - http, css, modules, js, webpack, npm, yarn, React, TypeScript

## также вспоминали ООП и классы

## Далее я позволил себе сохранить подробное задание чтоб читатель мог понять что надо делать
...
На этом экране вам предстоит сгенерировать `n` чисел последовательности Фибоначчи. **Компоненты**
